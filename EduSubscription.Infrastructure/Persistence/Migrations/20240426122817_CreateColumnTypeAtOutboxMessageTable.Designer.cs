...
namespace EduSubscription.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240426122817_CreateColumnTypeAtOutboxMessageTable")]
    partial class CreateColumnTypeAtOutboxMessageTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EduSubscription.Infrastructure.Persistence.Common.Outbox.OutboxMessage", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 26, 9, 28, 16, 537, DateTimeKind.Local).AddTicks(6964));
