...
namespace EduSubscription.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240511125402_CreateCoursesAggregateTables")]
    partial class CreateCoursesAggregateTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EduSubscription.Infrastructure.Persistence.Common.Outbox.OutboxMessage", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 11, 9, 54, 0, 915, DateTimeKind.Local).AddTicks(7871));
