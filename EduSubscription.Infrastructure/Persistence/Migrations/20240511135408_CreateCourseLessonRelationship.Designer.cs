...
namespace EduSubscription.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240511135408_CreateCourseLessonRelationship")]
    partial class CreateCourseLessonRelationship
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EduSubscription.Infrastructure.Persistence.Common.Outbox.OutboxMessage", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 11, 10, 54, 8, 253, DateTimeKind.Local).AddTicks(3264));
