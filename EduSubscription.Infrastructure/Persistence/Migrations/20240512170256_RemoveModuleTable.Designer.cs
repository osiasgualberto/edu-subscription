...
namespace EduSubscription.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240512170256_RemoveModuleTable")]
    partial class RemoveModuleTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EduSubscription.Infrastructure.Persistence.Common.Outbox.OutboxMessage", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 12, 14, 2, 56, 144, DateTimeKind.Local).AddTicks(821));
